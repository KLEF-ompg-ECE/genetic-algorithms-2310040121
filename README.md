...
**Student Name  :** N. RamyaShree
**Student ID    :** 2310040121 
...
```
The plot shows that the fitness value improves quickly during the early generations. 
The biggest improvement occurs in the first few generations as better solutions are discovered. 
After around 30–40 generations the curve becomes flatter, indicating that the algorithm has converged to a near-optimal solution.
```
